...
<div class="container mx-auto">
    <div class="mt-10">
        <form @submit.prevent="_storeNewTerminal" class="max-w-sm mx-auto">
            <div class="mb-2">
...
export default {
    ...
    methods: {
        ...mapActions('terminal', ['storeNewTerminal']),
        _validate() {
        ...
        async _storeNewTerminal() {
            try {
                if (!this._validate) {
                    return false
                }
                await this.storeNewTerminal(this.terminal)
                this._clearForm()
